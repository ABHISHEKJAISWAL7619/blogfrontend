...
const Navbar = () => {
  ...
  const handleSearchChanger = async(e)=>{
    ...
    let res = await axios.get(`https://blogbackend-i274.onrender.com/users/search?q=${value}`);
    let data = res.data;
...
<nav className="bg-white fixed z-50 top-0 left-0 right-0 border-gray-200 dark:bg-gray-900">
  <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    ...
    <img   className="w-8 h-8 rounded-full" src="https://static.vecteezy.com/system/resources/thumbnails/001/840/612/small/picture-profile-icon-male-icon-human-or-people-sign-and-symbol-free-vector.jpg" alt="" />}
