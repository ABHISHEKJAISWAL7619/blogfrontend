...
<div className=" mx-auto w-[90%] bg-white shadow-xl rounded-lg text-gray-900 relative">
  ...
  <div className='absolute right-0 top-1 cursor-pointer'>
    ...
    <img className="object-cover object-center h-32 w-32 rounded-full" src={userPics.profilePic? userPics.profilePic : userDetails.profilePic} alt="Woman looking front" />
  </div>
...
<div className='flex gap-5 mt-4 mx-auto w-[90%]'>
    ...
    <div className=' absolute z-10 top-20 right-10'>
      ...
      <TiThMenu  className='text-black bg-white '  size={25}/>
      </Button>
      <Modal title="Update form"   open={isModalOpen} onOk={handleOk} onCancel={handleCancel}>
        {/* <p>Some contents...</p>
        <p>Some contents...</p>
        <p>Some contents...</p> */}
        <label className=' w-[100px] mt-2 inline-block' htmlFor="">UserName:</label>
